...
model: sonnet
color: blue
skills: [security-best-practices, api-design, api-documentation, architecture-patterns, systematic-debugging, verification-before-completion, receiving-code-review, debugging]
maxTurns: 25
---
